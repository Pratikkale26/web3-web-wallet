...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-900 text-white p-4">
      <div className="w-full max-w-[90%] bg-gray-800 shadow-lg rounded-lg p-8">
        ...
        <div className="mb-8">
          ...
          <textarea
            ...
            readOnly
            rows={1}
            className="w-full border border-gray-600 rounded-lg p-4 text-gray-200 text-lg bg-gray-700 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <button
        ...
        {mnemonic && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Solana Wallet */}
              <div className="p-4 bg-gray-700 border border-gray-600 rounded-lg shadow-sm">
